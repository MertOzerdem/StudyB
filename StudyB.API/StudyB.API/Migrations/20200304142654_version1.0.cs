    ...
    public partial class version10 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d28888e9-2ba9-473a-a40f-e38cb54f9b35"), "Pasta", "Sempa", "123", "Pasta" },
                    { new Guid("da2fd609-d754-4feb-8acd-c4f9ff13ba96"), "Pepe", "Julian Onziema", "159", "LGBT Right Activist" },
                    { new Guid("8ded4df7-4355-41b0-9b44-a9de574bcc48"), "Ismini", "bulamadım", "159", "The Host" }
                });
